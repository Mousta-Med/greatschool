                                        ...
                                        <form method="POST" action="{{ route('students.update', $student) }}"
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                <div class="mt-3 w-full">
                                                    ...
                                                    <div class="lg:flex lg:justify-between">
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="studentname">Student Name</label>
                                                            <input
                                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                                id="studentname" type="text" name="name"
                                                                value="{{ $student->name }}" required>
                                                        </div>
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="studentage">Student Age</label>
                                                            <input
                                                                ...
                                                                id="studentage" type="number" name="age"
                                                                value="{{ $student->age }}" max="25" required>
                                                        </div>
                                                    </div>
                                                    <div class="lg:flex lg:justify-between">
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="studentphone">Student Phone</label>
                                                            <input
                                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                                id="studentphone" type="text" name="phone"
                                                                value="{{ $student->phone }}" required>
                                                        </div>
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="studentclass">Student Class</label>
                                                            <select
                                                                class="shadow border rounded lg:w-52 w-80 focus:outline-none focus:shadow-outline"
                                                                id="studentclass" name="class" required>
                                                    ...
                                                    <div class="my-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="studentphoto">Student Photo</label>
                                                        <input
                                                            ...
                                                            id="studentphoto" type="file" name="photo">
                                                    </div>
                                                    <div class="my-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="studentemail">Student Email</label>
                                                        <input
                                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                            id="studentemail" type="email" name="email"
