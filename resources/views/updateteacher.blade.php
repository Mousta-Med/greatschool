<x-app-layout>
    <div class="h-0 min-h-screen bg-gray-100">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto bg-sent">
                        ...
                        <nav aria-label="Sidebar" class="mt-5">
                            <div class="px-2 space-y-1">
                                ...
                                <a href="{{ route('logout') }}"
                                    class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg class="text-white group-hover:text-gray-500 mr-3 h-6 w-6" viewBox="0 0 24 24"
            ...
            <div class="hidden lg:flex lg:flex-shrink-0">
                <div class="flex flex-col w-64">
                    ...
                    <div class="flex-1 flex flex-col min-h-0 border-r border-gray-200 ">
                        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto bg-sent">
                            <div class="flex items-center flex-shrink-0 px-4">
                                <a href="{{ route('home') }}">
                                    <svg class="" xmlns="http://www.w3.org/2000/svg" width="99"
                                        height="51" viewBox="0 0 99 51">
                                        <path
                                            d="M16.94 13.14C16.3987 12.0013 15.6147 11.124 14.588 10.508C13.5613 9.87333 12.3667 9.556 11.004 9.556C9.64133 9.556 8.40933 9.87333 7.308 10.508C6.22533 11.124 5.36667 12.02 4.732 13.196C4.116 14.3533 3.808 15.6973 3.808 17.228C3.808 18.7587 4.116 20.1027 4.732 21.26C5.36667 22.4173 6.22533 23.3133 7.308 23.948C8.40933 24.564 9.64133 24.872 11.004 24.872C12.908 24.872 14.476 24.3027 15.708 23.164C16.94 22.0253 17.6587 20.4853 17.864 18.544H10.08V16.472H20.58V18.432C20.4307 20.0373 19.9267 21.512 19.068 22.856C18.2093 24.1813 17.08 25.236 15.68 26.02C14.28 26.7853 12.7213 27.168 11.004 27.168C9.19333 27.168 7.54133 26.748 6.048 25.908C4.55467 25.0493 3.36933 23.864 2.492 22.352C1.63333 20.84 1.204 19.132 1.204 17.228C1.204 15.324 1.63333 13.616 2.492 12.104C3.36933 10.5733 4.55467 9.388 6.048 8.548C7.54133 7.68933 9.19333 7.26 11.004 7.26C13.076 7.26 14.9053 7.77333 16.492 8.8C18.0973 9.82667 19.264 11.2733 19.992 13.14H16.94ZM34.225 27L29.577 19.02H26.497V27H23.949V7.484H30.249C31.7236 7.484 32.965 7.736 33.973 8.24C34.9996 8.744 35.765 9.42533 36.269 10.284C36.773 11.1427 37.025 12.1227 37.025 13.224C37.025 14.568 36.633 15.7533 35.849 16.78C35.0836 17.8067 33.9263 18.488 32.377 18.824L37.277 27H34.225ZM26.497 16.976H30.249C31.6303 16.976 32.6663 16.64 33.357 15.968C34.0476 15.2773 34.393 14.3627 34.393 13.224C34.393 12.0667 34.0476 11.1707 33.357 10.536C32.685 9.90133 31.649 9.584 30.249 9.584H26.497V16.976ZM43.5321 9.556V16.08H50.6441V18.18H43.5321V24.9H51.4841V27H40.9841V7.456H51.4841V9.556H43.5321ZM66.8756 22.66H58.3636L56.7956 27H54.1076L61.1636 7.596H64.1036L71.1316 27H68.4436L66.8756 22.66ZM66.1476 20.588L62.6196 10.732L59.0916 20.588H66.1476ZM86.2188 7.484V9.556H80.8988V27H78.3508V9.556H73.0028V7.484H86.2188Z"
                                            fill="white" />
                                        <path
                        ...
                        <div class="absolute inset-0 py-6 px-4 sm:px-6 lg:px-8">
                            <div class="h-full">
                                ...
                                <div class="flex items-center justify-center min-h-screen">
                                    <div
                                        class="relative inline-block align-bottom rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                <div class="mt-3 w-full">
                                                    ...
                                                    <div class="lg:flex lg:justify-between">
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="teachername">Teacher Name</label>
                                                            <input
                                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                                id="teachername" type="text" name="name"
                                                                value="{{ $teacher->name }}" required>
                                                        </div>
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="teachermaterial">Teacher material</label>
                                                            <select name="material_study"
                                                                class="shadow border rounded lg:w-52 w-80 focus:outline-none focus:shadow-outline"
                                                                id="teachermaterial">
                                                                <option
                                                                    {{ $teacher->material_study == 'Math' ? 'selected' : '' }}
                                                                    value="Math">Math</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'French' ? 'selected' : '' }}
                                                                    value="French">French</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'Physic' ? 'selected' : '' }}
                                                                    value="Physic">Physic</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'arab' ? 'selected' : '' }}
                                                                    value="arab">arab</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'englais' ? 'selected' : '' }}
                                                                    value="englais">englais</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'info' ? 'selected' : '' }}
                                                                    value="info">info</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'history' ? 'selected' : '' }}
                                                                    value="history">history</option>
                                                                <option
                                                                    {{ $teacher->material_study == 'philosophie' ? 'selected' : '' }}
                                                                    value="philosophie">philosophie
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="lg:flex lg:justify-between">
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="teacherphone">Teacher Phone</label>
                                                            <input
                                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                                id="teacherphone" type="text" name="phone"
                                                                value="{{ $teacher->phone }}" required>
                                                        </div>
                                                        <div class="my-4">
                                                            <label class="block text-gray-700 text-sm font-bold mb-2"
                                                                for="teacherclass">Teacher Class</label>
                                                            <select
                                                                class="shadow border rounded lg:w-52 w-80 focus:outline-none focus:shadow-outline"
                                                                id="teacherclass" name="class" required>
                                                                <option value="">Select class</option>
                                                                @foreach ($classes as $class)
                                                                    <option value="{{ $class->title }}"
                                                                        {{ $class->id == $teacher->class_id ? 'selected' : '' }}>
                                                                        {{ $class->title }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="my-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="teacherphoto">Teacher Photo</label>
                                                        <input
                                                            ...
                                                            id="teacherphoto" type="file" name="photo">
                                                    </div>
                                                    <div class="my-4">
                                                        <label class="block text-gray-700 text-sm font-bold mb-2"
                                                            for="teacheremail">Teacher Email</label>
                                                        <input
                                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                            id="teacheremail" type="email" name="email"
