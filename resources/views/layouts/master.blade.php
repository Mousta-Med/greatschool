                            ...
                            <div class="hidden sm:block sm:ml-6">
                                <div class="flex space-x-4">
                                    ...
                                    @if (auth()->check() && Auth::user()->role == 'teacher')
                                        <a class="text-white hover:text-place block px-3 pt-9 pb-1 text-base font-medium {{ request()->is('teacher') || request()->is('teacher/student/4') ? 'bg-place hover:bg-sent' : '' }}"
                                            href="{{ route('teacher') }}">
                                            {{ __('Students') }}
                                        </a>
                                    @endif
                                    @if (auth()->check() && Auth::user()->role == 'student')
                                        <a class="text-white hover:text-place block px-3 pt-9 pb-1 text-base font-medium {{ request()->is('student') || request()->is('teacher/student/4') ? 'bg-place hover:bg-sent' : '' }}"
                                            href="{{ route('student') }}">
                                            {{ __('Student') }}
                                        </a>
                                    @endif
                                        ...
                                        <div x-data="{ open: false }" x-init="window.addEventListener('click', event => {
                                            ...
                                            <div>
                                                <button type="button"
                                                    ...
                                                    <img class="h-8 w-8 rounded-full" src="/img/{{ Auth::user()->photo }}"
                                                        alt="">
                                                </button>
                                            </div>
                                            ...
                                            <div x-show="open" x-cloak
                                                ...
                                                <a href="{{ route('profile.edit') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-place hover:transition delay-75">Your
                                                    Profile</a>
                                                <a href="{{ route('logout') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-place hover:transition delay-75">
                                                    {{ __('Logout') }}
                                                </a>
                    ...
                    @else
                        <div class="pt-4 pb-3 border-t border-gray-700">
                            <div class="flex items-center px-5">
                                <div class="flex-shrink-0">
                                    <img class="h-10 w-10 rounded-full" src="/img/{{ Auth::user()->photo }}"
                                        alt="">
                                </div>
                            ...
                            <div class="mt-3 px-2 space-y-1">
                                <a href="{{ route('profile.edit') }}"
                                    class="px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-slate-600 hover:transition delay-75">Your
                                    Profile</a>
            ...
            <div class="flex flex-wrap text-white">
                ...
                <div class="w-full lg:w-1/3 md:w-1/2 p-4">
                    ...
                    <form action="#" class="mt-4">
                        <div class="mb-3">
                            <input class="form-control px-3 py-2 border rounded w-full" type="text"
                                placeholder="Enter your email address">
                            <button class="btn sent text-white px-3 pynb bbhjbhbh-2 rounded mt-2"
