                                        ...
                                        <div x-data="{ open: false }" x-init="window.addEventListener('click', event => {
                                            ...
                                            <div x-show="open" x-cloak
                                                ...
                                                <a href="{{ route('profile.edit') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-slate-600 hover:transition delay-75">Your
                                                    Profile</a>
                                                <a href="{{ route('logout') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-slate-600 hover:transition delay-75">
                                                    {{ __('Logout') }}
                                                </a>
