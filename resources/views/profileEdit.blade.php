                    ...
                    <div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
                        ...
                        <div class="mt-6 space-y-8">
                            ...
                            <form method="post" action="{{ route('profile.update') }}">
                                ...
                                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="name"
                                            class="block text-sm font-medium text-blue-gray-900">Name</label>
                            ...
                            <div class="pt-8 flex justify-end">
                                <a href="{{ route('home') }}">
                                    <button type="button"
                                        class="bg-red-600 py-2 px-4 border rounded-md shadow-sm text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-900">
                                        Cancel
                                    </button>
                                </a>
                            </div>
